...
public class HelixParameterSpec implements AlgorithmParameterSpec {
     ...
     *             if <tt>nonce</tt> is null
     * @throws IllegalArgumentException
     *             if <tt>nonce</tt> is not exactly 16 bytes in length
     */
     ...
     * @throws NullPointerException
     *             if either <tt>nonce</tt> or <tt>expectedMac</tt> is null
     * @throws IllegalArgumentException
     *             if either <tt>nonce</tt> or <tt>expectedMac</tt> is not
     ...
     * 
     * @return a copy of the 16-byte MAC, or <tt>null</tt> if the MAC was not
