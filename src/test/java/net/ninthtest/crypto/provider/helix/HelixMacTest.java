...
public class HelixMacTest implements HelixTestVectors {
    ...
    public void engineInitRejectsNonSecretKey() throws InvalidKeyException, InvalidAlgorithmParameterException {
        @SuppressWarnings("serial") PublicKey publicKey = new PublicKey() {
            @Override
    ...
    /*
     * tests for HelixMac#engineDoFinal()
     * (NOTE: Helix test vector #1 cannot be used because SecretKeyFactory will
     * not accept zero-byte key material)
     */
